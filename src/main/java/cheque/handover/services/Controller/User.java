...
public class User {
    ...
    public ResponseEntity<?> generateMis(HttpServletResponse response, @RequestParam String emailId, @RequestParam String reportType, @RequestParam(required = false) String selectedType,
                                         @RequestParam(name = "fromDate", required = false) String fromDate, @RequestParam(name = "toDate", required = false) String toDate,@RequestParam(name = "selectedDate", required = false) String selectedDate,@RequestParam(name = "status", required = false) String status)throws IOException {
        logger.info("Report generated by {} :" , emailId);
        List<MisReport> reportList = service.fetchReportData(reportType, selectedType, fromDate, toDate,selectedDate,status);
