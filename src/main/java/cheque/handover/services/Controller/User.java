...
public class User {
    ...
    public ResponseEntity<?> generateMis(HttpServletResponse response, @RequestParam String emailId, @RequestParam String reportType, @RequestParam(required = false) String selectedType,
                                         @RequestParam(name = "fromDate", required = false) Date fromDate, @RequestParam(name = "toDate", required = false) Date toDate,@RequestParam(name = "selectedDate", required = false) Date selectedDate)throws IOException {
