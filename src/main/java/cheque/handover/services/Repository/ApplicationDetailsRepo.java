...
//    List<ApplicationDetails> findDetailByBranchAndApplication(String branchName, String applicationNo, String status, Pageable pageable);
//
//    @Query("select count (d) from ApplicationDetails d where d.branchName =:branchName and d.applicationNumber =:applicationNo")
//    long findDetailByBranchAndApplicationCount(String branchName, String applicationNo, String status);
//
